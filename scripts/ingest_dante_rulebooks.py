...
BOOKS_TO_PROCESS = [
    {
        "filename": "Rulebook_1.0.pdf",
        "folder": "DANTE_RULEBOOK",
        "project": "Dante",
        "title_prefix": "Dante Core Rulebook",
        "tag": "[DANTE RULEBOOK]",
        "language": "en",
        "manual_id": 30
    },
    {
        "filename": "Start-Here-1.3_EN.FINAL_.pdf",
        "folder": "DANTE_START_HERE",
        "project": "Dante",
        "title_prefix": "Dante Start Here Guide",
        "tag": "[DANTE START HERE]",
        "language": "en",
        "manual_id": 31
    },
    {
        "filename": "Exploration-Book_1.0.pdf",
        "folder": "DANTE_EXPLORATION",
        "project": "Dante",
        "title_prefix": "Dante Exploration Book",
        "tag": "[DANTE EXPLORATION]",
        "language": "en",
        "manual_id": 32
    },
    {
        "filename": "Coliseum_Book_1.0.pdf",
        "folder": "DANTE_COLISEUM",
        "project": "Dante",
        "title_prefix": "Dante Coliseum Book",
        "tag": "[DANTE COLISEUM]",
        "language": "en",
        "manual_id": 33
    },
    {
        "filename": "Charons-Ferry_1.0-2.pdf",
        "folder": "DANTE_CHARONS_FERRY",
        "project": "Dante",
        "title_prefix": "Dante Charon's Ferry Booklet",
        "tag": "[DANTE CHARONS FERRY]",
        "language": "en",
        "manual_id": 34
    },
    {
        "filename": "Pristine_Booklet_1.0.pdf",
        "folder": "DANTE_PRISTINE",
        "project": "Dante",
        "title_prefix": "Dante Pristine Booklet",
        "tag": "[DANTE PRISTINE]",
        "language": "en",
        "manual_id": 35
    },
    {
        "filename": "Tainted_Booklet_1.0.pdf",
        "folder": "DANTE_TAINTED",
        "project": "Dante",
        "title_prefix": "Dante Tainted Booklet",
        "tag": "[DANTE TAINTED]",
        "language": "en",
        "manual_id": 36
    },
    {
        "filename": "Triad_Booklet_1.0.pdf",
        "folder": "DANTE_TRIAD",
        "project": "Dante",
        "title_prefix": "Dante Triad Booklet",
        "tag": "[DANTE TRIAD]",
        "language": "en",
        "manual_id": 37
    },
    {
        "filename": "Errata-Dante-1.5-06_02_2026.pdf",
        "folder": "DANTE_ERRATA",
        "project": "Dante",
        "title_prefix": "Dante Errata & FAQ 1.5",
        "tag": "[DANTE ERRATA]",
        "language": "en",
        "manual_id": 38
    }
...
def process_book(item: dict, sql_statements: list[str], conn, client):
    pdf_path = ROOT_DIR / "books" / "DANTE" / item["filename"]
    ...
    for page_idx in range(num_pages):
        page_num = page_idx + 1
        page_text = doc_fitz[page_idx].get_text()
...
def main():
    ...
    if conn:
        ...
        logger.info("PostgreSQL database is offline or unreachable. Generating SQL seed file for import...")

    client = get_openai_client()
    sql_statements = [
        "-- Dante Rulebooks Seed Script (All 9 Books)",
        "-- Generated automatically by ingest_dante_rulebooks.py",
        ""
    ]
    ...
    # Save SQL Seed File
    sql_seed_path = ROOT_DIR / "scripts" / "dante_manual_segments_seed.sql"
    with open(sql_seed_path, "w", encoding="utf-8") as f:
        f.write("\n".join(sql_statements))

    logger.info("=" * 70)
    logger.info("DANTE INGESTION & EMBEDDING GENERATION COMPLETE!")
