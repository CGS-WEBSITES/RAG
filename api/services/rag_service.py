    ...
    if category == "game_rules" and project:
        ...
        if character_prompt:
            system_prompt = (
                ...
                "- Be concise and direct. Answer in as few sentences as possible — do NOT elaborate beyond what was asked.\n"
                "- If the answer is one sentence, give one sentence. If it needs a list, keep it short.\n"
