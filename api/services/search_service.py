        ...
        if len(rows) < limit:
            ...
            if terms:
                expansions = {
                    ...
                    "trauma": ["trauma cube", "trauma cubes", "trauma", "knocked out", "knock out"],
                    "curse": ["curse cube", "curse cubes", "curse"],
                    "maldição": ["curse cube", "curse cubes", "curse"],
                    "maldicao": ["curse cube", "curse cubes", "curse"],
                    "vida": ["health", "knocked out", "trauma cube"],
                    "zerar": ["knocked out", "trauma cube", "health"],
                    "zero": ["knocked out", "trauma cube", "health"],
                    "dano": ["damage", "health", "knocked out"],
                    "recebo": ["receive", "gains", "knocked out", "trauma cube"],
                    "quando": ["when", "knocked out", "trauma cube"],
                    ...
                    "escuridao": ["darkness"],
                    "escuridão": ["darkness"],
                    "habilidade": ["ability", "skill", "skills", "upgrade", "upgrades"],
                    "habilidades": ["abilities", "skills", "skill", "upgrades"],
                    "skill": ["skills", "ability", "abilities", "upgrade", "upgrades", "level"],
                    "skills": ["skill", "ability", "abilities", "upgrade", "upgrades", "level"],
                    "upgrade": ["upgrades", "upgrading", "skill", "skills", "level", "evolution", "improvement"],
                    "upgrades": ["upgrade", "upgrading", "skill", "skills", "level", "evolution", "improvement"],
                    "character": ["hero", "heroes", "character", "characters", "player"],
                    "characters": ["hero", "heroes", "character", "player"],
                    "hero": ["heroes", "character", "characters"],
                    "heroes": ["hero", "character", "characters"],
                    "level": ["levels", "upgrade", "upgrades", "skill"],
                    "monstro": ["monster"],
                    "monstros": ["monsters"],
